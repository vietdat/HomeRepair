...
var DichVuThietKeModel = require('../../model/tintuc.model');
...
router.get('/', function(req, res, next) {
  DichVuThietKeModel.find(function(err, data) {
    if (err) throw err;
    else {
...
router.post('/add', function(req, res, next) {
  ...
  busboy.on('finish', function() {
    var item = new DichVuThietKeModel({
      url: url,
      title: title,
      content: content,
      image: {
    ...
    item.save(function(err) {
      if (err) throw err;
      else res.redirect('/hungthinh-admin/tin-tuc');
    })
  });
  req.pipe(busboy);
});
...
router.post('/update', function(req, res, next) {
  ...
  busboy.on('finish', function() {
    ...
    DichVuThietKeModel.findOneAndUpdate({
      _id: id
    },item,{
      upsert: true
    },function(err, doc){
