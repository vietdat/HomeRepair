          ...
          if( data.getData ) {
            ...
            for(var i = 0; i < length; i++) {
              if(i === 0) {
                ...
                +     '<div class="col-sm-2">'
                +       '<div>'
                +          '<a href="'+ config.domain + "/"+ req.params.url +"/dich-vu-thiet-ke/"  + data.getData[i].url +'" class="full-image">'
                ...
                +             '<a href="'+ config.domain + "/"+ req.params.url +"/dich-vu-thiet-ke/"  + data.getData[i].url +'"><h3 class="no-padding-top no-margin-top">'+ data.getData[i].title +'</h3></a>'
                +         '</h4>'
