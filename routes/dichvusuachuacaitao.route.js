...
router.get('/:url', function(req, res, next) {
  async.auto({
    linkbar:function(done) {
        ...
        linkbar[1] = linkbar[0] + "/dich-vu-sua-chua-cai-tao/" + req.params.url;
        var url_title = '';
          ...
          if( data.getData ) {
            ...
            for(var i = 0; i < length; i++) {
              if(i === 0) {
                html_head = html_head 
                        + '<div class="col-md-6">'
                        +    '<a href="'+ config.domain + "/dich-vu-sua-chua-cai-tao/sua-chua-cai-tao-nha-tron-goi/" + data.getData[i].url +'">'
                        ...
                        +             '<a href="'+ config.domain + "/dich-vu-sua-chua-cai-tao/" + data.getData[i].url +'"><h3>'+data.getData[i].title+'</h3></a>'
                        +         '</h3>'
                        +     '</header>'
                        +     '<div>'
                ...
                +     '<div class="col-sm-2">'
                +       '<div>'
                +          '<a href="'+ config.domain + "/dich-vu-sua-chua-cai-tao/" + data.getData[i].url +'" class="full-image">'
                ...
                +             '<a href="'+ config.domain + "/dich-vu-sua-chua-cai-tao/" + data.getData[i].url +'"><h3 class="no-padding-top no-margin-top">'+ data.getData[i].title +'</h3></a>'
                +         '</h4>'
